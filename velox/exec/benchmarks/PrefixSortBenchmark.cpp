...
class PrefixSortBenchmark {
 public:
  ...
  void smallBigint() {
    ...
    benchmark(
        "no-payload", "bigint", batchSizes, rowTypes, numKeys, iterations);
  }
  ...
  void smallBigintWithPayload() {
    ...
    std::vector<int> numKeys = {1, 2, 3, 4};
    benchmark("2payloads", "bigint", batchSizes, rowTypes, numKeys, iterations);
  }
  ...
  void largeBigint() {
    ...
    std::vector<int> numKeys = {1, 2, 3, 4};
    benchmark(
        "no-payloads", "bigint", batchSizes, rowTypes, numKeys, iterations);
  }
